...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-300 ease-spring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-br from-primary-900 via-primary-800 to-secondary-900 dark:from-primary-600 dark:via-primary-500 dark:to-secondary-600 text-white hover:from-primary-950 hover:via-primary-900 hover:to-secondary-950 dark:hover:from-primary-700 dark:hover:via-primary-600 dark:hover:to-secondary-700 shadow-[0_4px_14px_0_rgba(23,37,84,0.4),0_2px_4px_0_rgba(0,0,0,0.15)] dark:shadow-[0_4px_14px_0_rgba(59,130,246,0.15),0_2px_4px_0_rgba(0,0,0,0.1)] hover:shadow-[0_8px_20px_0_rgba(23,37,84,0.5),0_4px_8px_0_rgba(0,0,0,0.2)] dark:hover:shadow-[0_8px_20px_0_rgba(59,130,246,0.25),0_4px_8px_0_rgba(0,0,0,0.15)] active:scale-[0.98] before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/20 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300",
        destructive:
        ...
        secondary:
          "bg-gradient-to-br from-secondary-900 to-secondary-800 dark:from-secondary-500 dark:to-secondary-400 text-white hover:from-secondary-950 hover:to-secondary-900 dark:hover:from-secondary-600 dark:hover:to-secondary-500 shadow-[0_4px_14px_0_rgba(59,7,100,0.4)] dark:shadow-[0_4px_14px_0_rgba(168,85,247,0.15)] hover:shadow-[0_8px_20px_0_rgba(59,7,100,0.5)] dark:hover:shadow-[0_8px_20px_0_rgba(168,85,247,0.25)] active:scale-[0.98]",
